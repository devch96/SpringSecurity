...
public class JWTSimpleTest {
    ...
    void test_2() {
        //jjwt <=> java-jwt
        byte[] SEC_KEY = DatatypeConverter.parseBase64Binary("hoon");

        //incode
        String oauth0_token = JWT.create().withClaim("name", "hoon").withClaim("price", 3000)
    ...
    void test_3() throws InterruptedException {
        final Algorithm AL = Algorithm.HMAC256("hoon");
