...
public class SpELTest {
    ...
    void test_3(){
        ...
        assertFalse(parser.parseExpression("over(170)").getValue(horse, Boolean.class));
    }
    ...
    void test_4(){
        ...
        assertTrue(parser.parseExpression("over(170)").getValue(ctx, Boolean.class)); //setRootObject
        assertFalse(parser.parseExpression("#nancy.over(170)").getValue(ctx, Boolean.class)); //setVariable
