...
/*        String response = client.getForObject(greetingUrl(),String.class);
    ...
    @Test
    void test_3(){
        TestRestTemplate testClient = new TestRestTemplate("user1", "1111");//TestRestTemplate 는 Basic을 지원함
    ...
    void test_4(){
            ...
            ResponseEntity<String> resp = testClient.postForEntity(greetingUrl(),"hoon",String.class);
            assertEquals("hello hoon", resp.getBody());
    }
}
