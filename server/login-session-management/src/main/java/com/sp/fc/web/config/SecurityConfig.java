...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    ConcurrentSessionFilter c;
    SessionAuthenticationStrategy s;
...
//                        .sessionFixation(sessionFixationConfigurer -> sessionFixationConfigurer.none()) sessionFix는 보안위험이있음.
                        .maximumSessions(2)
                        .maxSessionsPreventsLogin(true) //새로운 세션 인정 기존 만료
